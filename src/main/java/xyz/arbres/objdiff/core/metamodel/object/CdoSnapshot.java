...
public final class CdoSnapshot extends Cdo {
    ...
    public boolean isInitial() {
        return type == SnapshotType.INITIAL;
    }

    public boolean isTerminal() {
        return type == SnapshotType.TERMINAL;
    }

    public boolean isUpdate() {
        return type == SnapshotType.UPDATE;
    }
     ...
     * <br/><br/>
     *
     * <b>Warning!</b> Version field was added in ObjDiff v. 1.4.4.
     * All snapshots persisted in ObjDiffRepository before this release
     * have version 0.
     * <br/>
     * If it isn't OK for you, run manual DB update.
     * See <a href="http://ObjDiff.org/documentation/features/#release-notes">release-notes</a>
     * for v. 1.4.4
     *
     * @since 1.4.4
     */
